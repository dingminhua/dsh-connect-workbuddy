...
export const en = {
  ...
  'row.creditsNearest': 'Nearest expiry',
  'row.creditsExpiryTime': 'Expires {expiresAt}',
  'row.creditsPackageTotal': 'Total {total}',
  'row.creditsPackageRemain': 'Remaining {remain}',
  'row.creditsActivities': 'Activities & packages',
  'row.creditsExpiringSoon': 'Expiring in 3 days',
  'row.packageCount': '{count} packages remaining',
  'row.refresh': 'Refresh',
...
export const zh: Record<WorkBuddySettingsKey, string> = {
  ...
  'row.creditsNearest': '最近到期',
  'row.creditsExpiryTime': '{expiresAt} 到期',
  'row.creditsPackageTotal': '总量 {total}',
  'row.creditsPackageRemain': '剩余 {remain}',
  'row.creditsActivities': '活动与套餐',
  'row.creditsExpiringSoon': '最近 3 天到期',
  'row.packageCount': '剩余 {count} 个包',
  'row.refresh': '刷新',
  'row.refreshing': '正在刷新…',
